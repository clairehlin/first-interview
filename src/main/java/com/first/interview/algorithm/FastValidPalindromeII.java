...
public class FastValidPalindromeII implements ValidPalindromeII {
    ...
    public boolean apply(String s) {
        ...
        return breakingPoint < 0 ||
                isPalindrome(chars, breakingPoint + 1, chars.length - breakingPoint - 1) < 0 ||
                isPalindrome(chars, breakingPoint, chars.length - breakingPoint - 1 - 1) < 0;
    }
